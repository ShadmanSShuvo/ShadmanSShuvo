...
I’m passionate about **full-stack development**, **artificial intelligence**, **machine learning**, and **systems programming**. I enjoy building practical software, exploring modern technologies, and continuously improving my engineering skills.
...
- 🗄️ Database systems and backend architecture
...
- 📚 **edu-Verse** — role-based e-learning platform built with Next.js, React, and PostgreSQL.
- 🤖 **Trinity-Learning** — AI-powered supplementary learning platform for the BUET CSE Fest 2026 Hackathon.
- 🛠️ **Repair Guru** — team project for the Solvio AI Hackathon built with TypeScript and modern web tools.
- 🎮 **AlgoMania** — Data Structures & Algorithms visualizer built with Java and JavaFX.
- 🧠 **Bangla Speech-to-Text** — speech recognition project focused on Bangla ASR experiments.
- ⚡ **FlappyBird** — C/C++ and OpenGL-based game project.
...
<div align="left" style="background-color: #0d1117; padding: 10px; border-radius: 10px;">
  ...
  <a href="https://www.linkedin.com/in/ShadmanSShuvo/" target="_blank" style="margin-right: 10px;" title="LinkedIn">
    <img src="https://img.shields.io/badge/LinkedIn-Connect-blue?style=flat-square&logo=linkedin" alt="LinkedIn" height="22"/>
  </a>
  <a href="https://www.youtube.com/@Shadman_Shuvo/" target="_blank" style="margin-right: 10px;" title="YouTube">
    <img src="https://img.shields.io/badge/YouTube-@Shadman__Shuvo-red?style=flat-square&logo=youtube" alt="YouTube" height="22"/>
  </a>
</div>
